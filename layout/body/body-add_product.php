<script type="text/javascript" src="../../work/js/add-product.js"></script>
<div id="add-brand" class="modal fade modal-small" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h3 class="modal-title">เพิ่มยี่ห้อสินค้า</h3>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" onclick="addProductBrand()" class="btn btn-primary">บันทึก</button>
            </div>
        </div>
    </div>
</div>
...
<div id="edit-brand" class="modal fade modal-small" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h3 class="modal-title">แก้ไขยี่ห้อสินค้า</h3>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" onclick="editProductBrand()" class="btn btn-primary">บันทึก</button>
            </div>
        </div>
    </div>
</div>
...
<div id="add-type-product" class="modal fade modal-small" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h3 class="modal-title">เพิ่มประเภทสินค้า</h3>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" onclick="addProductType()" class="btn btn-primary">บันทึก</button>
            </div>
        </div>
    </div>
</div>
...
<div id="edit-type-product" class="modal fade modal-small" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" onclick="editProductType()" class="btn btn-primary">บันทึก</button>
            </div>
        </div>
    </div>
</div>
...
<div id="add-product-modal" class="modal fade modal-small" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <form id="add-product" enctype="multipart/form-data" method="post" action="">
                    <table class="modal-table">
                        ...
                        <tr>
                            ...
                            <td style="text-align:left;">
                                <!--<select name="typeid" size="3" class="form-control">
                                    <?php
            ...
            <div class="modal-footer">
                <button type="button" onclick="addProduct()" class="btn btn-primary">บันทึก</button>
            </div>
        </div>
    </div>
</div>
...
<div id="show-type" class="modal fade modal-small" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h3 class="modal-title">ประเภทของเครื่องปริ้น</h3>
...
<div id="edit-product-modal" class="modal fade modal-small" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" onclick="updateProduct()" class="btn btn-primary">บันทึก</button>
            </div>
        </div>
    </div>
</div>
