                ...
                for($i=0;$i<$count_div;$i++){
                    ...
                    for($j;$j<$countdata;$j++){
                        if(empty($_SESSION['MEMBER_ID'])){
                            ...
                            $faverite = '<a style="height:34px;" href="javascript:void(0)" onclick="faverite('.$result_product_new[$j]['productID'].')" class="btn btn-warning"><span class="glyphicon glyphicon-star-empty"></span></a>';
                        }
                        ?>
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <p style="text-align:right"><?=$faverite?> <a href="javascript:void(0)" class="btn btn-primary" onclick="<?=$event_click?>" role="button">หยิบใส่ตะกร้า</a> <a href="javascript:void(0)" class="btn btn-default" onclick="getShowDetailProduct(<?=$result_product_new[$j]['productID']?>)" role="button">รายละเอียด</a></p>
                                    </div>
                                </div>
                            </div>
                        <?php
