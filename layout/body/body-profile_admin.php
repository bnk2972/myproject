<?php
$SELECT = "SELECT * FROM employee WHERE employeeID = {$_SESSION['ADMIN_ID']}";
            ...
            <form class="form-horizontal">
                ...
                <div style="border:1px solid #ccc; padding:10px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"> 
                            <input type="text" class="form-control" name="phone" id="phone" placeholder="กรุณากรอกเบอร์โทร" value="<?=!empty($result[0]['phone']) ? $result[0]['phone']:""?>">
                        </div>
                    </div>
                    <div class="form-group" style="margin-bottom:0px;"> 
                        <div class="col-sm-offset-2 col-sm-10">
...
<script>
    function editProfile(){
        ...
        $.ajax({
            url:"ajax/editProfile_admin.php",
            data:{
                pwdold:pwdold,
                pwdnew:pwdnew,
                pwd:pwd
